...
**Перевести текст с экрана.** Нажмите `Ctrl+Alt+S` или **«С экрана»** → обведите текст на любом мониторе → дождитесь локального распознавания и перевода в обычном попапе. `Esc` и правая кнопка мыши отменяют выбор. Ошибки распознавания можно поправить через **«Исправить текст»**. Сейчас OCR рассчитан на русский и английский; [архитектура, приватность и ограничения](docs/screen-translation.md).
